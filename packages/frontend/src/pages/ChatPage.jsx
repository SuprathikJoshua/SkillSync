								...
								{msgs.map((msg) => {
									...
									return (
										...
										>
											{!isMine && (
												<div
													className="w-7 h-7 rounded-full flex items-center justify-center font-bold text-white text-xs shrink-0 mr-2 mt-1"
													style={{
														background:
				...
				>
					<div className="flex items-end gap-3">
						...
						<button
							...
							className="shrink-0 w-10 h-10 rounded-xl flex items-center justify-center text-white transition-opacity"
							style={{
								background: "linear-gradient(135deg,#4f46e5,#7c3aed)",
								border: "none",
