...
const SessionsPage = () => {
  ...
  const handleStatus = async (id, status) => {
    try {
      ...
      if (status === "completed") {
        toast.success(
          "Session completed! 🎉 Tokens added to teacher's wallet.",
        );
  ...
  return (
    ...
    >
      ...
      <Sidebar />
      <main
        style={{ paddingTop: "4rem", paddingLeft: "15rem", minHeight: "100vh" }}
      >
        <div
          style={{
            background:
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-primary text-sm">
                            {typeof s.skillId === "object"
                              ? s.skillId?.name
                              : "Unknown Skill"}
                          </p>
                          <p className="text-xs text-secondary mt-0.5">
                            {s.teacherId?.fullName || "?"} →{" "}
                            {s.learnerId?.fullName || "?"}
                          </p>
          ...
          >
            <div className="card rounded-2xl p-8 w-full max-w-lg shadow-2xl">
              ...
              <div className="space-y-4">
                {[
                  { label: "Teacher", key: "teacherId", opts: users },
                  { label: "Learner", key: "learnerId", opts: users },
                ].map(({ label, key, opts }) => (
                  <div key={key}>
                    <label
                      style={{
