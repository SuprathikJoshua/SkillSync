...
const navigation = [
  ...
  { name: "Badges", icon: "Badges", path: "/badges" },
  { name: "Matchmaking", icon: "Matchmaking", path: "/matchmaking" },
...
const Sidebar = () => {
  ...
  return (
    <div className="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] bg-white shadow-xl z-30 overflow-y-auto">
